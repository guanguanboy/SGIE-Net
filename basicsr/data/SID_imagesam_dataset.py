...
class Dataset_SIDImageSam(data.Dataset):
    def __init__(self, opt):
        super(Dataset_SIDImageSam, self).__init__()
        self.opt = opt
    ...
    def __getitem__(self, index):
        ...
        if self.opt['phase'] == 'train':
            ...
            img_LQ_numpy = img_LQ[0]
            img_GT = img_GT[0]

            img_LQ_l = [img_LQ_numpy]
        ...
        r,g,b = img_LQ_numpy[0]+1, img_LQ_numpy[1]+1, img_LQ_numpy[2]+1
