...
class Illumination_seg_gray_ill_Estimator(nn.Module):
    ...
    def forward(self, rgb, edge):
        ...
        illu_fea = self.depth_conv(illu_fea)

        #illu_map = self.conv2(illu_fea)
        return illu_fea
            
class SGIENetEdgeWDync2(nn.Module):
...
if __name__ == '__main__':
    ...
    net = SGIENetEdgeWDync2(img_channel=img_channel, width=width, middle_blk_num=middle_blk_num,
