...
class SGIENetEdgeWDyncWFeatsGatedFuse(nn.Module):
    ...
    def forward(self, inp):
        ...
        seg_feats = self.prior_generator(img_rgb, seg_map)
        ...
        input = torch.cat([img_rgb, seg_map],dim=1)
...
if __name__ == '__main__':
    ...
    net = SGIENetEdgeWDyncWFeatsGatedFuse(img_channel=img_channel, width=width, middle_blk_num=middle_blk_num,
