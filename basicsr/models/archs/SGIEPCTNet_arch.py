...
class SGIEPCTNet(nn.Module):
    ...
    def __init__(self, img_channel=3, width=16, middle_blk_num=1, enc_blk_nums=[], dec_blk_nums=[]):
        ...
        self.depth_conv1 = nn.Conv2d(in_channels=4, out_channels=width, kernel_size=1, bias=True)
...
if __name__ == '__main__':
    ...
    net = SGIEPCTNet(img_channel=img_channel, width=width, middle_blk_num=middle_blk_num,
