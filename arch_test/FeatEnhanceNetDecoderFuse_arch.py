...
class FeatEnhanceDecoderFuseNet(nn.Module):
...
if __name__ == '__main__':
    ...
    samenhancenet = FeatEnhanceDecoderFuseNet(img_channel=3, width=width, middle_blk_num=middle_blk_num, enc_blk_nums=enc_blks, dec_blk_nums=dec_blks).cuda()
