...
if __name__ == '__main__':
    ...
    fuse_net = GFM(in_channels=32).cuda()
    
    input_sam_image = torch.randn(2, 32, 16, 16).cuda()

    inter_meditate_feats = torch.randn(2, 32, 16, 16).cuda()

    output_sam = fuse_net(input_sam_image, inter_meditate_feats)
